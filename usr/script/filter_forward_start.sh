...
iptables -t filter -N wifi_client_block_chain
iptables -t filter -N CwmpIpMacFilter_chain
...
iptables -t filter -A FORWARD -j wifi_client_block_chain
iptables -t filter -A FORWARD -j CwmpIpMacFilter_chain
