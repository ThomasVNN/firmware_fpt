...
<td  colspan="3" valign="middle" class="title-main"><%tcWebApi_get("String_Entry","ACLText","s")%></td>
</tr>
</table>
...
<tr>
    ...
    <td width="440">&nbsp;</td>
		...
		<tr>
			...
			<td class="tabdata"><div align=right> <%tcWebApi_get("String_Entry","ACLACLText","s")%> </div></td>
			<td class="tabdata"><div align=center>:</div></td>
			<td class="tabdata">
				<INPUT TYPE="RADIO" NAME="ActivateRDO" VALUE="Yes"
				<%if TCWebAPI_get("ACL_Common", "Activate", "h") = "Yes" then asp_write("checked") end if %> onClick="aclSwitch(1);init()"> <%tcWebApi_get("String_Entry","ACLActivatedText","s")%> 
				<INPUT TYPE="RADIO" NAME="ActivateRDO" VALUE="No"
				<%if TCWebAPI_get("ACL_Common", "Activate", "h") = "No" then asp_write("checked") end if %> onClick="aclSwitch(0)"> <%tcWebApi_get("String_Entry","ACLDeactivatedText","s")%> 
			</td>
		</tr>
		...
		<tr>
		       <td>&nbsp;</td>
		       <td>&nbsp;</td>
			<td height="25" class="title-sub"> <%tcWebApi_get("String_Entry","ACLEditingText","s")%> </td>
			<td colspan="2">&nbsp;</td>
		</tr>
		<tr>
			<td width="150" height="25" class="light-orange">&nbsp;</td>
			<td width="10" class="light-orange"></td>
			<td class="tabdata"><div align=right> <%tcWebApi_get("String_Entry","ACLEditingRuleIndexText","s")%> </div></td>
			<td class="tabdata"><div align=center>:</div></td>
			<td class="tabdata">
		...
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata"><div align=right> <%tcWebApi_get("String_Entry","ACLEditingActiveText","s")%> </div></td>
			<td class="tabdata"><div align=center>:</div></td>
			<td class="tabdata">
				<INPUT TYPE="RADIO" NAME="RuleActiveRDO" VALUE="Yes" 
				<%if TCWebAPI_get("ACL_Entry", "Activate", "h") = "Yes" then asp_write("checked") end if %>> <%tcWebApi_get("String_Entry","ACLYesText","s")%> 
				<INPUT TYPE="RADIO" NAME="RuleActiveRDO" VALUE="No" 
				<%if TCWebAPI_get("ACL_Entry", "Activate", "h") = "No" then asp_write("checked") end if
				  if TCWebAPI_get("ACL_Entry", "Activate", "h") = "N/A" then asp_write("checked") end if  %>> <%tcWebApi_get("String_Entry","ACLNoText","s")%> 
			</td>
			</td>
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata"><div align=right> <%tcWebApi_get("String_Entry","ACLListSecureIPText","s")%> </div></td>
			<td class="tabdata"><div align=center>:</div></td>
			<td class="tabdata">
				...
				"<%if TCWebAPI_get("ACL_Entry", "ScrIPAddrEnd", "h") <> "N/A" then TCWebAPI_get("ACL_Entry", "ScrIPAddrEnd", "s") else asp_Write("0.0.0.0") end if %>" > <%tcWebApi_get("String_Entry","ACLEditingSrcIPDescripText","s")%> 
			</td>
		</tr>
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata"><div align=right> <%tcWebApi_get("String_Entry","ACLListAppText","s")%> </div></td>
			<td class="tabdata"><div align=center>:</div></td>
			<td class="tabdata">
		...
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata"><div align=right><%tcWebApi_get("String_Entry","ACLListInterfaceText","s")%></div></td>
			<td class="tabdata"><div align=center>:</div></td>
			<td class="tabdata">
	...
	<table width="760" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		...
		<tr>
		       ...
		       <td>&nbsp;</td>
		       <td>&nbsp;</td>
			<td height="25" class="title-sub"> <%tcWebApi_get("String_Entry","ACLListText","s")%></td>
			<td>&nbsp;</td>
		</tr>
	...
	<table width="760" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr>
			...
			<td width="440" class="orange" align="center">
