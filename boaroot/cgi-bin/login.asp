				...
				<div id=div_visite >
					<form id="configform" name="configform" action="/cgi-bin/login.asp" method="get">		
							...
							<tr>
								<td>
									<table  cellspacing="0" cellpadding="0" align="center" border="0" width="500" height="160"  >									
								  		...
								  		<tr>
										   	<td height=25px></td>
										   	<td style="color:red; font-family: Arial,Helvetica,sans-serif;font-size: 15px;font-weight:bold;text-algin:left;">
						...
						<table cellspacing="0"  width="500" style="padding-top:20px;">
							<tr height="20px">
								<td width="320px"></td>
						  		<td style="color:grey; font-family: Arial,Helvetica,sans-serif;font-size: 15px;font-weight:bold;text-align:left; padding-right:40px;"><%tcWebApi_get("String_Entry", "HotlineText", "s")%></td>
						  	</tr>

						  	<tr height="30px">
						  		<td width="320px"></td>
						  		<td style="color:red; font-family: Arial,Helvetica,sans-serif;font-size: 20px;font-weight:bold;text-align:left; padding-right:40px;"><%tcWebApi_get("String_Entry", "HotlineNumText", "s")%></td>
						  	</tr>
						  </table>
						  -->
						  <!--gleaf added end-->
					  		...
					  		<tr>
					    			<td>
					      				<table cellSpacing=0 width="100%">
					        				<tbody>
					        					<tr>
										          	<td style="BACKGROUND: white" height=3></td>
											</tr>
										</tbody>
									</table>
									...
									<table cellSpacing=0 cellPadding=0 width=800 bgColor=#ffffff>
										<tbody>
											<tr>
										          	...
										          	<td class=model vAlign=bottom align=right width=600 height=50>
										          		<font color=#000000>
								      ...
								      <table height=1 cellSpacing=0 cellPadding=0 width=800 align=center bgColor=#cccccc border=0>
								        	<tbody>
								        		<tr>
					          						<td></td>
					          					</tr>
								      ...
								      <table style="background-color: white" height=300 cellSpacing=0 width="100%" summary="" border=0>
								        	<tbody>
								        		<tr>
								          			<td align=middle>
								            				<div id=maincontent style="width: 600px">
								            					<table id=box_header style="border:1px solid" cellSpacing=0 >
								              					<tbody>
													              	<tr>
													                		<td class=orange width=300 colSpan=3 height=20 border="0"></td>
													                	</tr>
													                  			...
													                  			<table height=100  border=0 colspan="3" width=300>
													                    			<tbody>
													                    				<tr>
													                      					...
													                      					<td><input id="username" style="width: 150px; font-family: arial" name="username" size="20"></td>
													                      				</tr>
