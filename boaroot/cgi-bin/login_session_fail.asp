				...
				<table  cellspacing="0" cellpadding="0" align="center" border="0" width="500" height="160"  >
				  ...
				  <tr>
				     <td height=25px>
					    ...
					    <td><div style="color:red; text-align:left;font-family: Arial,Helvetica,sans-serif;font-size: 15px;font-weight:bold;"><%tcWebApi_get("String_Entry", "SessionFailInfo", "s")%></div></td>
				  </tr>
