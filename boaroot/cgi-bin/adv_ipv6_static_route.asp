...
border=0>
  ...
  <TR>
    <TD class=title-main width=150 height=30>Static 
      Route  </TD>
    <TD width=10>&nbsp;</TD>
    ...
    <TD class=light-orange>&nbsp;</TD>
    <TD class=tabdata>
      <DIV align=right> <% tcWebApi_get("String_Entry","AdvIP6SRouteRuleIndex","s") %>  </DIV></TD>
    <TD class=tabdata>
  ...
  <TR>
    ...
    <TD class=light-orange>&nbsp;</TD>
    <TD class=tabdata>
      <DIV align=right> <% tcWebApi_get("String_Entry","AdvIP6SRouteAddPre","s") %>  
          </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
    <TD class=tabdata><INPUT name="staticDestIP" maxLength=39 size=39 value="<%If TcWebApi_get("Route6_Entry","DST_IP","h") <> "N/A" then TcWebApi_get("Route6_Entry","DST_IP","s") else asp_Write("::1") end if %>" ><font size=+1>&nbsp;/&nbsp; 
	<INPUT TYPE="TEXT" NAME="DstIPv6Prefix" SIZE="3" MAXLENGTH="3" VALUE="<%if tcwebapi_get("Route6_Entry","Prefix","h")<> "N/A" then tcwebApi_get("Route6_Entry","Prefix","s") else asp_write("128") end if%>"></font></TD></TR>
 
  <TR>
    <TD class=light-orange>&nbsp;</TD>
    <TD class=light-orange>&nbsp;</TD>
    <TD class=tabdata>
      <DIV align=right> <% tcWebApi_get("String_Entry","AdvIP6SRouteGatewIP","s") %>  </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
    <TD class=tabdata>
  ...
  <TR>
	...
	<TR>
		<TD class=title-main width=150 height=30>IPv6 Static Route Table Listing  </TD>
		<TD width=10>&nbsp;</TD>
