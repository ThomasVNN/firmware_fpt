...
<table width="760" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <%tcWebApi_get("String_Entry","VLANTopText","s")%>    </td><td width="10" class="black">&nbsp;</td><td width="150"><hr noshade></td><td width="10" ><hr noshade></td><td width="440"><hr noshade></td></tr><tr>
    <td class="light-orange">&nbsp;</td><td class="light-orange"></td><td height="30" class="tabdata"><div align=right>
    <%tcWebApi_get("String_Entry","VLANTopFunctionText","s")%>   </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
        <INPUT TYPE="RADIO" NAME="Vlan_active" VALUE="1" <%TcWebApi_get(VLAN_ACTIVATED)%> onclick="submit()">	   <%tcWebApi_get("String_Entry","VLANTopActivatedText","s")%>       
        <INPUT TYPE="RADIO" NAME="Vlan_active" VALUE="0" <%TcWebApi_get(VLAN_DEACTIVATED)%> onclick="submit()">  <%tcWebApi_get("String_Entry","VLANTopDeactivatedText","s")%>        </td></tr><tr>  
    ...
    <td height="20" class="light-orange">&nbsp;</td><td class="light-orange"></td><td height="30">&nbsp;</td><td>&nbsp;</td><td class="tabdata">&nbsp;</td></tr></table><table width="760" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td width="160" height="42" >&nbsp;</td><td width="160" class="orange">&nbsp;</td><td width="440" class="orange"></td></tr></table><p>&nbsp;</p>
</div></form>
</body></html>
