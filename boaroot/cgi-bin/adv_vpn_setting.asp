...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td width="150" height="30" class="title-main">
      <%tcWebApi_get("String_Entry","SetAdvVPNConnListText","s")%>  </td>
	...
	<td colspan="3" align=center>
      <table width="580" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" bgcolor="#FFFFFF">
		<tr height="30">
		  ...
		  <td width="120" align=center class="tabdata"><strong> <%tcWebApi_get("String_Entry","SetAdvConnectionNameText","s")%> </strong></td>
		  <td width="100" align=center class="tabdata"><strong> <%tcWebApi_get("String_Entry","SetAdvRemoteGatewayText","s")%> </strong></td>
		  <td width="100" align=center class="tabdata"><strong> <%tcWebApi_get("String_Entry","SetAdvLocalAddressText","s")%> </strong></td>
		  <td width="100"  align=center class="tabdata"><strong> <%tcWebApi_get("String_Entry","SetAdvRemoteAddressText","s")%> </strong></td>
		  <td align=center class="tabdata"><strong> <%tcWebApi_get("String_Entry","SetAdvEditText","s")%> </strong></td>
		  <td align=center class="tabdata"><strong> <%tcWebApi_get("String_Entry","SetAdvDropText","s")%> </strong></td>
          </tr>
...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr height="42">
	...
	<td width="440" class="orange">
	  <input name="Add New Connection" type="button" value="<%tcWebApi_get("String_Entry","SetAdvAddNewConnText","s")%>" onClick="totalConnCheck()">
  	</tr>
</table>
