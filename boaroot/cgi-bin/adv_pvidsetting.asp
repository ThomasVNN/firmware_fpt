...
<div align="center">
	<table width="760" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr> 
        ...
        <td width="1">&nbsp;</td>
        <td colspan="4" align="center" class="tabdata">  <%tcWebApi_get("String_Entry","PvidsettingActiveText","s")%> 
          <INPUT TYPE="RADIO" NAME="VlanTag_Active" ID="VlanTag_ActiveID" VALUE="Yes" <% if tcWebApi_get("VlanTag_Entry", "Active", "h") = "Yes" then asp_Write("checked") end if%> onclick="init();">
           <%tcWebApi_get("String_Entry","PvidsettingActivatedText","s")%>  
          <INPUT TYPE="RADIO" NAME="VlanTag_Active" ID="VlanTag_ActiveID" VALUE="No" <% if tcWebApi_get("VlanTag_Entry", "Active", "h") = "No" then asp_write("checked") end if%> onclick="init();">
           <%tcWebApi_get("String_Entry","PvidsettingDeactivatedText","s")%> </td>
      </tr>
	  <tr> 
	  ...
	  <tr> 
       <td class="light-orange">&nbsp;</td>
        ...
        <td colspan="2" align="center" class="tabdata">  <B><%tcWebApi_get("String_Entry","PvidsettingPORTText","s")%></B> 
        </td>
		<td align="center" class="tabdata">  <B><%tcWebApi_get("String_Entry","PvidsettingPVIDText","s")%></B> 
        </td>
		<td align="left" class="tabdata">  <B><%tcWebApi_get("String_Entry","PvidsettingTAGText","s")%></B> 
        </td>
      </tr>
	  <tr> 
        <td class="light-orange">&nbsp;</td>
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td width="199" class="tabdata"><div align="right"> <%tcWebApi_get("String_Entry","PvidsettingATMText","s")%>  
      ...
      <tr > 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> <%tcWebApi_get("String_Entry","PvidsettingVC1Text","s")%> 
...
<%if tcWebApi_get("WebCustom_Entry","havePtm","h") = "Yes" then%>
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td width="199" class="tabdata"><div align="right"> 
		<%tcWebApi_get("String_Entry","PvidsettingPtm0Text","s")%>  
...
<%if tcWebApi_get("WebCustom_Entry","haveWan0","h") = "Yes" then%>
      ...
      <tr> 
        ...
        <td class="light-orange"></td>
        <td width="199" class="tabdata"><div align="right">  
            <%tcWebApi_get("String_Entry","PvidsettingWan0Text","s")%>  
