...
If Request_Form("SaveFlag")="1" Then
	TCWebApi_set("WLan11ac_Common","APAifsn","ap_aifsn_all")
	TCWebApi_set("WLan11ac_Common","APCwmin","ap_cwmin_all")
	TCWebApi_set("WLan11ac_Common","APCwmax","ap_cwmax_all")
	TCWebApi_set("WLan11ac_Common","APTxop","ap_txop_all")
	TCWebApi_set("WLan11ac_Common","APACM","ap_acm_all")
	TCWebApi_set("WLan11ac_Common","BSSAifsn","sta_aifsn_all")
	TCWebApi_set("WLan11ac_Common","BSSCwmin","sta_cwmin_all")
	TCWebApi_set("WLan11ac_Common","BSSCwmax","sta_cwmax_all")
	TCWebApi_set("WLan11ac_Common","BSSTxop","sta_txop_all")
	TCWebApi_set("WLan11ac_Common","BSSACM","sta_acm_all")
	TCWebApi_set("WLan11ac_Common","AckPolicy","ap_ackpolicy_all")		
...
function initValue()
{
   var APAifsn    = '<% tcWebApi_get("WLan11ac_Common","APAifsn","s") %>';
   var APCwmin    = '<% tcWebApi_get("WLan11ac_Common","APCwmin","s") %>';
   var APCwmax    = '<% tcWebApi_get("WLan11ac_Common","APCwmax","s") %>';
   var APTxop     = '<% tcWebApi_get("WLan11ac_Common","APTxop","s") %>';
   var APACM      = '<% tcWebApi_get("WLan11ac_Common","APACM","s") %>';
   var BSSAifsn   = '<% tcWebApi_get("WLan11ac_Common","BSSAifsn","s") %>';
   var BSSCwmin   = '<% tcWebApi_get("WLan11ac_Common","BSSCwmin","s") %>';
   var BSSCwmax   = '<% tcWebApi_get("WLan11ac_Common","BSSCwmax","s") %>';
   var BSSTxop    = '<% tcWebApi_get("WLan11ac_Common","BSSTxop","s") %>';
   var BSSACM     = '<% tcWebApi_get("WLan11ac_Common","BSSACM","s") %>';
   var AckPolicy  = '<% tcWebApi_get("WLan11ac_Common","AckPolicy","s") %>';
...
<form method=post name=wmm action="/cgi-bin/wifiqa_wmm_5G.asp">
<INPUT TYPE="HIDDEN" NAME="SaveFlag" value="0">
  <table align="center" width="540" border="1" cellspacing="0" cellpadding="3" vspace="2" hspace="2" bordercolor="#999999" style="margin-top:60px;">
    <tr> 
