<%
	...
	if request_Form("Add_or_Delete") = "1" then
		...
		if tcWebApi_get("WebCustom_Entry","haveXPON","h") = "Yes" then
			...
			'TCWebAPI_set("PortBind_Entry", "p1", "PortBind_PON_Port_1")wang delete for only use one wan port 20190927
			'TCWebAPI_set("PortBind_Entry", "p2", "PortBind_PON_Port_2")
			'TCWebAPI_set("PortBind_Entry", "p3", "PortBind_PON_Port_3")
			'TCWebAPI_set("PortBind_Entry", "p4", "PortBind_PON_Port_4")wang delete
		...
		if request_Form("wlan11acISExist") = "On" then
			if request_Form("11ACMBSSIDNumber") = "1" then
				TCWebAPI_set("PortBind_Entry", "r0", "PortBind_Wireless11ac_Port_0")
			elseif request_Form("11ACMBSSIDNumber") = "2" then
				TCWebAPI_set("PortBind_Entry", "r0", "PortBind_Wireless11ac_Port_0")	
				TCWebAPI_set("PortBind_Entry", "r1", "PortBind_Wireless11ac_Port_1")
			elseif request_Form("11ACMBSSIDNumber") = "3" then
				TCWebAPI_set("PortBind_Entry", "r0", "PortBind_Wireless11ac_Port_0")
				TCWebAPI_set("PortBind_Entry", "r1", "PortBind_Wireless11ac_Port_1")
				TCWebAPI_set("PortBind_Entry", "r2", "PortBind_Wireless11ac_Port_2")
			elseif request_Form("11ACMBSSIDNumber") = "4" then
				TCWebAPI_set("PortBind_Entry", "r0", "PortBind_Wireless11ac_Port_0")
				TCWebAPI_set("PortBind_Entry", "r1", "PortBind_Wireless11ac_Port_1")
				TCWebAPI_set("PortBind_Entry", "r2", "PortBind_Wireless11ac_Port_2")
				TCWebAPI_set("PortBind_Entry", "r3", "PortBind_Wireless11ac_Port_3")
			end if
		end if
...
{
	var port;
	/*wang change port range from 8 to 4*//*wang change 4 to 1 for only use one wan port 20190927*/
...
function wlan11acOnOffSwitch(on_off)
{
	var port;
	var bssidNum = document.getElementById("11ACMBSSIDNumber").value;
	
	if (document.getElementById("IDwlan11acISExist").value == "On") {
		for (port = 0; port < bssidNum; port++) {
			var pt = document.getElementById("PortBind_Wireless11ac_Port_" + port);
			var Tag = document.getElementById("PortBind_Wireless11ac_Tag_" + port);
			if (on_off == 0) {
				pt.disabled = true;
				continue;
			}
...
function init()
{
	...
	document.getElementById("PortBind_active").style.display="block";
	document.getElementById("PortBind_Sum").style.display="block";
...
<%end if%>
	...
	document.getElementById("PortBind_active").style.display="none";
	document.getElementById("PortBind_Sum").style.display="none";
...
<%if tcWebApi_get("WebCustom_Entry","haveXPON","h") = "Yes" then%>
	/* pon port *//*wang chang port< 8 to port < 4*/
	for (port = 0; port < 1; port++) {
...
<%end if%>
	...
	if (document.getElementById("IDwlan11acISExist").value == "On") {
		for (port = 0; port < bssidNum; port++) {
			var Tag = document.getElementById("PortBind_Wireless11ac_Port_" + port);
			if (Tag.checked) {
				Tag.value = "Yes";
			}
			else {
...
function onClickPortBindSummary()
{
	...
	<!--<body leftmargin="20" topmargin="0" rightmargin="15" bottommargin="0" marginwidth="0" marginheight="0" onload="init()">-->
	<body onload="init()">
<FORM METHOD="POST" ACTION="/cgi-bin/adv_portbinding.asp" name="PortBind_form">
			<div id="pagestyle"><!--cindy add for border 11/28-->
				<div id="block1">
					<table width="640px" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="tabdata" style="padding-left:20px;">
						<tr height="32px">

							<td width="250px" align="left" class="title-main">
								<%tcWebApi_get("String_Entry","PortbingdingSettingText","s")%>
							</td>
</tr>

						<tr height="30px">

						    	<td width="250px" align="left" class="tabdata"><%tcWebApi_get("String_Entry","PortbingdingActiveText","s")%></td>
						     	<td align=left class="tabdata">
						     		<INPUT TYPE="RADIO" NAME="PortBind_active" VALUE="Yes" <% if tcWebApi_get("PortBind_Common", "Active", "h") = "Yes" then asp_Write("checked") end if%> onclick="init()"> 
							    	<%tcWebApi_get("String_Entry","PortbingdingActivatedText","s")%>
    
							    	&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE="RADIO" NAME="PortBind_active" VALUE="No" <% if tcWebApi_get("PortBind_Common", "Active", "h") = "No" then asp_write("checked") end if%> onclick="init()">  
							    	<%tcWebApi_get("String_Entry","PortbingdingDeactivatedText","s")%> 
    </td>
 </tr>
						</table>
						<div id="PortBind_active">
						<table width="640px" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="tabdata" style="padding-left:20px;">
						<tr height="30px">
 
						    	<td width="250px" align=left class="tabdata"><%tcWebApi_get("String_Entry","PortbingdingGroupIndexText","s")%></td>
						     	<td align=left class="tabdata">
...
<%if tcWebApi_get("WebCustom_Entry","haveXPON","h") = "Yes" then%>
							    	...
							    	<td width="250px" align=left class="tabdata"><%tcWebApi_get("String_Entry","PortbingdingPONText","s")%></td>
							     	<td align=left class="tabdata">
		<table border="1" cellpadding="0" cellspacing="0" bordercolor="#b3b3b3" >
			<tr> 
											<td rowspan="2" width="50px" class="tabdata"><div align=center> <%tcWebApi_get("String_Entry","PortbingdingPortText","s")%>  </div></td>
											<td width="30px">
												<div align=center> 
...
<%if tcWebApi_get("WebCustom_Entry","haveAtm","h") = "Yes" then%>
							    	...
							    	<td width="250px" align=left class="tabdata"><%tcWebApi_get("String_Entry","PortbingdingATMText","s")%></td>
							     	<td align=left class="tabdata">
							     		<table border="1" cellpadding="0" cellspacing="0" bordercolor="#b3b3b3" width="170px">
            <tr> 
											<td rowspan="2" width="50px" class="tabdata"><div align=center> <%tcWebApi_get("String_Entry","PortbingdingPortText","s")%>  </div></td>
											<td width="30px">
												<div align=center> 
...
<%end if%>
 ...
 <%if tcWebApi_get("WebCustom_Entry","havePtm","h") = "Yes" then%>
 	<%if tcWebApi_get("WebCustom_Entry","isMultiSerSupported","h") = "Yes" then%>
								    	...
								    	<td width="250px" align=left class="tabdata"><%tcWebApi_get("String_Entry","PortbindingPTM0Text","s")%></td>
								     	<td align=left class="tabdata">
      	<table border="1" cellpadding="0" cellspacing="0" bordercolor="#b3b3b3" width="70">
        <tr> 
									        		<td rowspan="2" class="tabdata" width="50px"><div align=center>  
													<%tcWebApi_get("String_Entry","PortbingdingPortText","s")%> </div>
												</td>
...
-->	
	...
	<%else%>
								    	...
								    	<td width="250px" align=left class="tabdata"><%tcWebApi_get("String_Entry","PortbingdingPTMText","s")%></td>
								     	<td width="440" height="80" align=left class="tabdata">
      	<table border="1" cellpadding="0" cellspacing="0" bordercolor="#b3b3b3" width="70">
            <tr> 
              <td rowspan="2" class="tabdata"><div align=center>  
										  			<%tcWebApi_get("String_Entry","PortbingdingPortText","s")%>  </div>
										  		</td>
							              			<td>
							              				<div align=center> 
...
<%end if%>
 ...
 <%if tcWebApi_get("WebCustom_Entry","haveWan0","h") = "Yes" then%>
							    	...
							    	<td width="250px" align=left class="tabdata"><%tcWebApi_get("String_Entry","PortbingdingWANText","s")%></td>
							     	<td height="80" align=left class="tabdata">
      	<table border="1" cellpadding="0" cellspacing="0" bordercolor="#b3b3b3" width="270">
            <tr> 
              <td rowspan="2" class="tabdata"><div align=right>  
											  	<%tcWebApi_get("String_Entry","PortbingdingPortText","s")%>  </div>
											</td>
			...
			<%end if%>
						...
						<tr height="60px">
							<%end if%>
						    	...
						    	<td width="250px" align=left class="tabdata"><%tcWebApi_get("String_Entry","PortbingdingEthernetText","s")%></td>
						     	<td align=left class="tabdata">
						     		<table border="1" cellpadding="0" cellspacing="0" bordercolor="#b3b3b3">
							      		<tr>
							        		<td rowspan="2" class="tabdata" width="50px"><div align=center>
								 		...
								 		<td width="30px"><div align=center>
									            	<INPUT TYPE="CHECKBOX" NAME="PortBind_Ethernet_Port_1" ID="PortBind_Ethernet_Port_1" <%if tcWebApi_get("PortBind_Entry", "e1", "h") = "Yes" then asp_write("checked") end if%> >            </div>
									       </td>        
									       <td width="30px"><div align=center>
									            	<INPUT TYPE="CHECKBOX" NAME="PortBind_Ethernet_Port_2" ID="PortBind_Ethernet_Port_2" <%if tcWebApi_get("PortBind_Entry", "e2", "h") = "Yes" then asp_write("checked") end if%> >            </div>
									       </td>
									       <% if tcWebApi_get("WebCustom_Entry","is2PSupported","h") <> "Yes" then %>
									       	<td width="30px"><div align=center>
												<INPUT TYPE="CHECKBOX" NAME="PortBind_Ethernet_Port_3" ID="PortBind_Ethernet_Port_3" <%if tcWebApi_get("PortBind_Entry", "e3", "h") = "Yes" then asp_write("checked") end if%> >            </div>
											</td>
											<td width="30px"><div align=center>
									            		<INPUT TYPE="CHECKBOX" NAME="PortBind_Ethernet_Port_4" ID="PortBind_Ethernet_Port_4" <%if tcWebApi_get("PortBind_Entry", "e4", "h") = "Yes" then asp_write("checked") end if%> >            </div>
									            	</td>
<%end if%>
									</tr>

      <tr>
								        	<td class="tabdata" width="30px"><div align=center>0</div></td>        
										<td class="tabdata" width="30px"><div align=center>1</div></td>
		<% if tcWebApi_get("WebCustom_Entry","is2PSupported","h") <> "Yes" then %>
											<td class="tabdata" width="30px"><div align=center>2</div></td>
											<td class="tabdata" width="30px"><div align=center>3</div></td>   
		<% end if%>   
		</tr>
...
<% if tcWebApi_get("Info_WLan","isExist","h") = "On" then %>
							<%if TCWebAPI_get("WLan_Common","BssidNum","h") = "1" then%>
								<tr height="60px">
								    	...
								    	<td width="250px" align=left class="tabdata"><%tcWebApi_get("String_Entry","PortbingdingWLanText","s")%></td>
								     	<td align=left class="tabdata">
     <table border="1" cellpadding="0" cellspacing="0" bordercolor="#b3b3b3">
      <tr>
								        			<td rowspan="2" class="tabdata" width="50px"><div align=center>
								         			...
								         			<td width="30px"><div align=center>
								            				<INPUT TYPE="CHECKBOX" NAME="PortBind_Wireless_Port_0" ID="PortBind_Wireless_Port_0" <%if tcWebApi_get("PortBind_Entry", "w0", "h") = "Yes" then asp_write("checked") end if%> >            </div>
								            			</td>  
								            		</tr>
...
<%if tcWebApi_get("WebCustom_Entry","isC2TrueSupported","h")<>"Yes" then%>
													<td width="30px"><div align=center>
										    				<INPUT TYPE="CHECKBOX" NAME="PortBind_Wireless_Port_1" ID="PortBind_Wireless_Port_1" <%if tcWebApi_get("PortBind_Entry", "w1", "h") = "Yes" then asp_write("checked") end if%> >            </div>
										    			</td>
<%end if%>
	 										</tr>
     ...
     <table border="1" cellpadding="0" cellspacing="0" bordercolor="#b3b3b3">
      <tr>
										        	<td rowspan="2" class="tabdata" width="50px"><div align=center>
										         	...
										         	<td width="30px"><div align=center>
										            		<INPUT TYPE="CHECKBOX" NAME="PortBind_Wireless_Port_0" ID="PortBind_Wireless_Port_0" <%if tcWebApi_get("PortBind_Entry", "w0", "h") = "Yes" then asp_write("checked") end if%> value="" >            </div>
										            	</td>
<%if tcWebApi_get("WebCustom_Entry","isC2TrueSupported","h")<>"Yes" then%>
													<td width="30px"><div align=center>
												    		<INPUT TYPE="CHECKBOX" NAME="PortBind_Wireless_Port_1" ID="PortBind_Wireless_Port_1" <%if tcWebApi_get("PortBind_Entry", "w1", "h") = "Yes" then asp_write("checked") end if%> >            </div>
													...
													<td width="30px"><div align=center>
										            			<INPUT TYPE="CHECKBOX" NAME="PortBind_Wireless_Port_2" ID="PortBind_Wireless_Port_2" <%if tcWebApi_get("PortBind_Entry", "w2", "h") = "Yes" then asp_write("checked") end if%> >            </div>
										            		</td>
<%end if%>
		 									</tr>
...
<%if tcWebApi_get("WebCustom_Entry","isC2TrueSupported","h")<>"Yes" then%>
													...
													<td width="30px"><div align=center>
								            					<INPUT TYPE="CHECKBOX" NAME="PortBind_Wireless_Port_3" ID="PortBind_Wireless_Port_3" <%if tcWebApi_get("PortBind_Entry", "w3", "h") = "Yes" then asp_write("checked") end if%> >            </div>
								            				</td>
<%end if%>
		</tr>
...
<% if tcWebApi_get("Info_WLan11ac","isExist","h") = "On" then %>
							<%if TCWebAPI_get("WLan11ac_Common","BssidNum","h") = "1" then%>
								<tr height="60px">
								    	...
								    	<td width="250px" align=left class="tabdata"><%tcWebApi_get("String_Entry","PortbingdingWLan11acText","s")%></td>
								     	<td align=left class="tabdata">
								     		<table border="1" cellpadding="0" cellspacing="0" bordercolor="#b3b3b3">
		<tr>
								        			<td rowspan="2" class="tabdata" width="50px"><div align=center>
								         			...
								         			<td width="30px"><div align=center>
								            				<INPUT TYPE="CHECKBOX" NAME="PortBind_Wireless11ac_Port_0" ID="PortBind_Wireless11ac_Port_0" <%if tcWebApi_get("PortBind_Entry", "r0", "h") = "Yes" then asp_write("checked") end if%> >            </div>
								            			</td>  
								            		</tr>
      ...
      <tr>
		 ...
		 <INPUT TYPE="HIDDEN" NAME="PortBind_Wireless11ac_Tag_0" ID="PortBind_Wireless11ac_Tag_0" VALUE="<%if tcWebApi_get("PortBind_Common", "r0", "h") <> "N/A" then tcWebApi_get("PortBind_Common", "r0", "s") end if%>">
								 		</table>
									</td>
								</tr> 		
		...
		<tr>
												...
												<td width="30px"><div align=center>
										    			<INPUT TYPE="CHECKBOX" NAME="PortBind_Wireless11ac_Port_1" ID="PortBind_Wireless11ac_Port_1" <%if tcWebApi_get("PortBind_Entry", "r1", "h") = "Yes" then asp_write("checked") end if%> >            </div>
										    		</td>
								 			</tr>
      ...
      <tr>
		 ...
		 <INPUT TYPE="HIDDEN" NAME="PortBind_Wireless11ac_Tag_0" ID="PortBind_Wireless11ac_Tag_0" VALUE="<%if tcWebApi_get("PortBind_Common", "r0", "h") <> "N/A" then tcWebApi_get("PortBind_Common", "r0", "s") end if%>">
		 <INPUT TYPE="HIDDEN" NAME="PortBind_Wireless11ac_Tag_1" ID="PortBind_Wireless11ac_Tag_1" VALUE="<%if tcWebApi_get("PortBind_Common", "r1", "h") <> "N/A" then tcWebApi_get("PortBind_Common", "r1", "s") end if%>">
										</table>
									</td>
								</tr>  
     ...
     <table border="1"cellpadding="0" cellspacing="0" bordercolor="#b3b3b3">
      <tr>
										        	<td rowspan="2" class="tabdata" width="50px">
        <div align=center>
         <%tcWebApi_get("String_Entry","PortbingdingPortText","s")%>         
         </div>
         </td>

										         	<td width="30px"><div align=center>
										          		<INPUT TYPE="CHECKBOX" NAME="PortBind_Wireless11ac_Port_0" ID="PortBind_Wireless11ac_Port_0" <%if tcWebApi_get("PortBind_Entry", "r0", "h") = "Yes" then asp_write("checked") end if%> value="" >            </div>
										          	</td>
												<td width="30px"><div align=center>
												    	<INPUT TYPE="CHECKBOX" NAME="PortBind_Wireless11ac_Port_1" ID="PortBind_Wireless11ac_Port_1" <%if tcWebApi_get("PortBind_Entry", "r1", "h") = "Yes" then asp_write("checked") end if%> >            </div>
												</td>
												<td width="30px"><div align=center>
										          		<INPUT TYPE="CHECKBOX" NAME="PortBind_Wireless11ac_Port_2" ID="PortBind_Wireless11ac_Port_2" <%if tcWebApi_get("PortBind_Entry", "r2", "h") = "Yes" then asp_write("checked") end if%> >            </div>
										          	</td>
											 </tr>
		...
		<INPUT TYPE="HIDDEN" NAME="PortBind_Wireless11ac_Tag_0" ID="PortBind_Wireless11ac_Tag_0" VALUE="<%if tcWebApi_get("PortBind_Common", "r0", "h") <> "N/A" then tcWebApi_get("PortBind_Common", "r0", "s") end if%>">
		<INPUT TYPE="HIDDEN" NAME="PortBind_Wireless11ac_Tag_1" ID="PortBind_Wireless11ac_Tag_1" VALUE="<%if tcWebApi_get("PortBind_Common", "r1", "h") <> "N/A" then tcWebApi_get("PortBind_Common", "r1", "s") end if%>">
		<INPUT TYPE="HIDDEN" NAME="PortBind_Wireless11ac_Tag_2" ID="PortBind_Wireless11ac_Tag_2" VALUE="<%if tcWebApi_get("PortBind_Common", "r2", "h") <> "N/A" then tcWebApi_get("PortBind_Common", "r2", "s") end if%>">
										</table>
									</td>
								</tr> 
        ...
        <%tcWebApi_get("String_Entry","PortbingdingPortText","s")%> 
												...
												<td width="30px"><div align=center>
										          		<INPUT TYPE="CHECKBOX" NAME="PortBind_Wireless11ac_Port_3" ID="PortBind_Wireless11ac_Port_3" <%if tcWebApi_get("PortBind_Entry", "r3", "h") = "Yes" then asp_write("checked") end if%> >            </div>
										          	</td>
											</tr>
		...
		<INPUT TYPE="HIDDEN" NAME="PortBind_Wireless11ac_Tag_1" ID="PortBind_Wireless11ac_Tag_1" VALUE="<%if tcWebApi_get("PortBind_Common", "r1", "h") <> "N/A" then tcWebApi_get("PortBind_Common", "r1", "s") end if%>">
		<INPUT TYPE="HIDDEN" NAME="PortBind_Wireless11ac_Tag_2" ID="PortBind_Wireless11ac_Tag_2" VALUE="<%if tcWebApi_get("PortBind_Common", "r2", "h") <> "N/A" then tcWebApi_get("PortBind_Common", "r2", "s") end if%>">
		<INPUT TYPE="HIDDEN" NAME="PortBind_Wireless11ac_Tag_3" ID="PortBind_Wireless11ac_Tag_3" VALUE="<%if tcWebApi_get("PortBind_Common", "r3", "h") <> "N/A" then tcWebApi_get("PortBind_Common", "r3", "s") end if%>">
										</table>
									</td>
								</tr>   
<%end if%>
...
<%if tcwebApi_get("Info_Ether","isUSBSupported","h")="Yes" then%>
							<tr height="60px">
							    	...
							    	<td width="250px" align=left class="tabdata"><%tcWebApi_get("String_Entry","PortbingdingUSBText","s")%></td>
							     	<td align=left class="tabdata">
	  <table border="1" cellpadding="0" cellspacing="0" bordercolor="#b3b3b3">
        <tr class="tabdata">
									        	<td rowspan="2" class="tabdata" width="50px">
...
<%end if%>
				...
				<div id="PortBind_Sum">
				<div id="button0" style="margin-bottom:10px">
					<table width="640px" border="0"  cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="tabdata" style="padding-left:20px;">
						<tr height="30px">

						    	<td width="250px" align="left" class="tabdata"><%tcWebApi_get("String_Entry","PortbingdingSummaryText","s")%></td>
						     	<td align=left class="tabdata">
						     		<INPUT TYPE="BUTTON" NAME="PortBind_Summary" class="button1" VALUE="<%tcWebApi_get("String_Entry","ButtonBindingSumText","s")%>" onClick="onClickPortBindSummary();"> 
	</td>
	</tr>
  </table>	
				</div>
				...
				<div id="button0">
					<table width="640" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="tabdata" style="padding-left:20px;">						
						<tr height="30px">
							
							<td width="80px" align=left class="tabdata">
								<INPUT TYPE="SUBMIT" class="button1" NAME="SaveBtn_PortBind_group" VALUE="<%tcWebApi_get("String_Entry","ButtonSaveText","s")%>" onClick="doAdd();">
							</td>
							<td width="20px">&nbsp;</td>
							<td align=left class="tabdata">
								<INPUT TYPE="SUBMIT" class="button1" id="del" NAME="DeleteBtn_PortBind_group" VALUE="<%tcWebApi_get("String_Entry","ButtonDeleteText","s")%>" onclick="document.PortBind_form.Add_or_Delete.value = 2"> 
							</td>
							<td width="20px">&nbsp;</td>
							<td align=left class="tabdata" style="display:none">
								<input type="SUBMIT"  class="button1" name="PortBind_group_cancel" value="<%tcWebApi_get("String_Entry","ButtonCancelText","s")%>" onClick="document.PortBind_form.Add_or_Delete.value = 3"> 
							</td>
						</tr>
					</table>
				</div>
...
<%end if%>	
	...
	<INPUT TYPE="HIDDEN" NAME="11ACMBSSIDNumber" ID="11ACMBSSIDNumber" VALUE="<%tcWebApi_get("WLan11ac_Common","BssidNum","s")%>">
