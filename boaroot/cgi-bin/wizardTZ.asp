...
<html>
	...
	<body topmargin="10" leftmargin="0">
		<% if tcWebApi_get("WebCustom_Entry", "isWiz8021qSupported", "h") = "Yes" then %>
			<form name="wzTimeZoneform" method="post" ACTION="/cgi-bin/wizard8021q.asp">
		<%else%>
					...
					<tr>
					    	<td class="orange">
					        	<div id="button0" align="right" style="width:500px">
					          		<input name="BackBtn" type="button" width="50" class="button1" value="<% tcWebApi_get("String_Entry","ButtonBackText","s") %>" class="tabdata" onClick="javascript:window.location='/cgi-bin/wizardpwd.asp'">
