...
<table width="760" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <%tcWebApi_get("String_Entry","VLANGroupText","s")%>     </td><td width="10">&nbsp;</td><td width="150"><hr noshade></td><td width="10" ><hr noshade></td><td width="440"><hr noshade></td></tr><tr>
    <td width="150" height="20" class="light-orange">&nbsp;</td><td width="10" class="light-orange"></td><td height="30" class="tabdata"><div align=right>
     <%tcWebApi_get("String_Entry","VLANGroupIndexText","s")%>     </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
...
<%TCWebApi_get(VLAN_INDEX)%>
    ...
    <td class="light-orange">&nbsp;</td><td class="light-orange">&nbsp;</td><td class="tabdata"><div align=right>
     <%tcWebApi_get("String_Entry","VLANGroupActiveText","s")%>     </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
    	<INPUT TYPE="RADIO" NAME="VlanGroup_active" VALUE="Yes" <% TCWebApi_get(VLAN_ACTIVEYES) %> >         <%tcWebApi_get("String_Entry","VLANGroupYesText","s")%> 
    	<INPUT TYPE="RADIO" NAME="VlanGroup_active" VALUE="No" <% TCWebApi_get(VLAN_ACTIVENO) %> >         <%tcWebApi_get("String_Entry","VLANGroupNoText","s")%>         </td></tr><tr>
    <td width="150" height="20" class="light-orange">&nbsp;</td><td width="10" class="light-orange">&nbsp;</td><td width="150" height="30" class="tabdata"> <div align=right>
     <%tcWebApi_get("String_Entry","VLANGroupVLANIDText","s")%>     </div></td><td width="10" class="tabdata"><div align=center>:</div></td><td width="440" class="tabdata">
        <INPUT TYPE="TEXT" NAME="VlanGroup_id" SIZE="9" MAXLENGTH="9" VALUE=<% TCWebApi_get(VLAN_ID) %> >         <%tcWebApi_get("String_Entry","VLANGroupVLANIDCommText","s")%>         </td></tr><tr>
    <td width="150" class="light-orange">&nbsp;</td><td class="light-orange"></td><td width="150" class="tabdata"> <div align=right>
     <%tcWebApi_get("String_Entry","VLANGroupATMVCText","s")%>     </div></td><td class="tabdata"><div align=center>:</div></td><td width="440" height="80" class="tabdata">
      <table border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
      <tr class="tabdata">
        <td class="tabdata"><div align=right>
         <%tcWebApi_get("String_Entry","VLANGroupTaggedText","s")%>         </div></td><td class="tabdata"><div align=center>
        ...
        <td rowspan="2" class="tabdata"><div align=right>
         <%tcWebApi_get("String_Entry","VLANGroupPortText","s")%>         </div></td><td><div align=center>
    ...
    <td width="150" height="20" class="light-orange">&nbsp;</td><td class="light-orange"></td><td width="150" height="45" class="tabdata"> <div align=right>
     <%tcWebApi_get("String_Entry","VLANGroupEthernetText","s")%>     </div></td><td class="tabdata"><div align=center>:</div></td><td width="440" height="70" class="tabdata"><table border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
      <tr>
        <td class="tabdata"><div align=right>
		 <%tcWebApi_get("String_Entry","VLANGroupTaggedText","s")%> 		</div></td><td><div align=center>
    ...
    <td height="25" class="light-orange">&nbsp;</td><td class="light-orange">&nbsp;</td><td height="80" class="tabdata">
      <div align=right>
       <%tcWebApi_get("String_Entry","VLANGroupUSBText","s")%>       </div></td><td class="tabdata"><div align=center>:</div></td><td height="25" class="tabdata"><table border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
      <tr class="tabdata">
        <td class="tabdata"><div align=right>
		 <%tcWebApi_get("String_Entry","VLANGroupTaggedText","s")%> 		</div></td><td><div align=center>
    ...
    <td height="20" class="light-orange">&nbsp;</td><td class="light-orange"></td><td height="30">&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr></table><table width="760" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td width="150" height="30" class="title-sub">
     <%tcWebApi_get("String_Entry","VLANGroupSummaryText","s")%>     </td><td width="10" class="light-orange">&nbsp;</td><td width="10" ><hr noshade class="light-orange-line"></td><td width="580"><hr noshade class="light-orange-line"></td><td width="10" ><hr noshade class="light-orange-line"></td></tr><tr>
    <td class="light-orange">&nbsp;</td><td class="light-orange"></td><td>&nbsp;</td><td><table border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" bgcolor="#FFFFFF">
      <tr height="30">
        <td width="30"  align=center class="tabdata"><strong>
         <%tcWebApi_get("String_Entry","VLANGroupSummary0Text","s")%></strong></td><td width="45"  align=center class="tabdata"><strong>
         <%tcWebApi_get("String_Entry","VLANGroupSummary1Text","s")%></strong></td><td width="40"  align=center class="tabdata"><strong>
         <%tcWebApi_get("String_Entry","VLANGroupSummary2Text","s")%></strong></td><td width="225" align=center class="tabdata"><strong>
         <%tcWebApi_get("String_Entry","VLANGroupSummary3Text","s")%></strong></td><td width="225" align=center class="tabdata"><strong>
         <%tcWebApi_get("String_Entry","VLANGroupSummary4Text","s")%></strong> </td></tr>
