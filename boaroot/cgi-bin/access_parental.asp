...
<table width="760" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td width="150" height="30" class="title-main"><%tcWebApi_get("String_Entry","ParentalControlText","s")%></td>
    <td width="10">&nbsp;</td><td width="150"></td>
    <td width="10" ></td>
    <td width="440"></td>
  </tr>
  <tr>
    ...
    <td class="light-orange"></td>
    <td class="tabdata"><div align=right> <%tcWebApi_get("String_Entry","ParentalEnableText","s")%> </div></td>
    <td class="tabdata"><div align=center>:</div></td>
    <td class="tabdata">
      <INPUT NAME="tr_Active" TYPE="RADIO" onClick="timeSwitch(1)" id="tr_Active_Yes" VALUE="Yes" <% If TCWebApi_get("Parental_Entry","Enable","h") = "Yes" then asp_Write("checked") end if%> > <%tcWebApi_get("String_Entry","ParentalActivatedText","s")%> 
      <INPUT NAME="tr_Active" TYPE="RADIO" onClick="timeSwitch(0)" id="tr_Active_No" VALUE="No" <% If TCWebApi_get("Parental_Entry","Enable","h") <> "Yes" then asp_Write("checked") end if%> > <%tcWebApi_get("String_Entry","ParentalDeactivatedText","s")%> 
    </td>
  </tr>
<% if tcWebApi_get("WebCustom_Entry","isParental_Urlblock","h") = "Yes" then %>
  <tr>
  ...
  <tr>
    <td class="light-orange">&nbsp;</td>
    <td class="light-orange"></td>
    <td class="tabdata"><div align=right> <%tcWebApi_get("String_Entry","ParentalBlockingTypeText","s")%> </div></td>
    <td class="tabdata"><div align=center>:</div></td>
    <td class="tabdata"> 
	<input name="tr_BlockType" type="RADIO" onClick="typeSwitch(1)" id="tr_BlockType_MAC" value="MAC" <% If TCWebApi_get("Parental_Entry","BlockType","h") = "N/A" then asp_Write("checked") elseif TCWebApi_get("Parental_Entry","BlockType","h") = "MAC" then asp_Write("checked") end if%> > <%tcWebApi_get("String_Entry","ParentalMACText","s")%>  
    <INPUT NAME="tr_BlockType" TYPE="RADIO" onClick="typeSwitch(0)" id="tr_BlockType_URL" VALUE="URL" <% If TCWebApi_get("Parental_Entry","BlockType","h") <> "N/A" then If TCWebApi_get("Parental_Entry","BlockType","h") <> "MAC" then asp_Write("checked") end if end if%> > <%tcWebApi_get("String_Entry","ParentalURLText","s")%>  
	</td>
  </tr>
  <% End If %> 
  </table>
...
<table width="760" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">	
  ...
  <tr>
    <td class="light-orange">&nbsp;</td>
    <td class="light-orange"></td>
    <td class="tabdata"><div align=right> <%tcWebApi_get("String_Entry","ParentalMACAddressText","s")%> </div></td>
    <td class="tabdata"><div align=center>:</div></td>
    <td class="tabdata">
...
<table width="760" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">	
  ...
  <tr>
    <td class="light-orange">&nbsp;</td>
    <td class="light-orange"></td>
		<td class="tabdata"><div align=right> <%tcWebApi_get("String_Entry","ParentalURLText","s")%> </div></td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
