...
border=0>
  ...
  <TR>
    <TD class=title-main width=150 height=30><%tcWebApi_get("String_Entry","SetAdvVPNConnText","s")%>  </TD>
    <TD  width=10>&nbsp;</TD>
    <TD width=150>
      <HR noShade>
    </TD>
  ...
  <TR>
    ...
    <TD class=light-orange>&nbsp;</TD>
    <TD class=tabdata>
      <DIV align=right> <%tcWebApi_get("String_Entry","SetAdvConnectionNameText","s")%>  
    </DIV></TD>
    <TD class=tabdata>
  ...
  <TR>
    ...
    <TD class=light-orange></TD>
    <TD class=tabdata>
      <DIV align=right> <%tcWebApi_get("String_Entry","SetAdvLocalGatewayIPText","s")%>  </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
  ...
  <TR>
    ...
    <TD class=light-orange></TD>
    <TD class=tabdata>
      <DIV align=right> <%tcWebApi_get("String_Entry","SetAdvRemoteGatewayIPText","s")%>  </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
  ...
  <TR>
    ...
    <TD class=light-orange>&nbsp;</TD>
    <TD class=tabdata>
      <DIV align=right> <%tcWebApi_get("String_Entry","SetAdvLocalAccessRangeText","s")%>  </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
    <TD class=tabdata>
  ...
  <TR>
    ...
    <TD class=light-orange></TD>
    <TD class=tabdata>
      <DIV align=right> <%tcWebApi_get("String_Entry","VirsvrCgiLocalIP","s")%>  </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
  ...
  <TR>
    ...
    <TD class=light-orange></TD>
    <TD class=tabdata>
      <DIV align=right> <%tcWebApi_get("String_Entry","SetAdvLocalIPSubMskText","s")%>  </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
  ...
  <TR>
    ...
    <TD class=light-orange>&nbsp;</TD>
    <TD class=tabdata>
      <DIV align=right> <%tcWebApi_get("String_Entry","SetAdvRemoteAccessRangeText","s")%>  </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
    <TD class=tabdata>
  ...
  <TR>
    ...
    <TD class=light-orange></TD>
    <TD class=tabdata>
      <DIV align=right> <%tcWebApi_get("String_Entry","SetAdvRemoteIPAddressText","s")%>  </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
  ...
  <TR>
    ...
    <TD class=light-orange></TD>
    <TD class=tabdata>
      <DIV align=right> <%tcWebApi_get("String_Entry","WirelessSharedKeyText","s")%>  </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
  ...
  <TR>
    ...
    <TD class=light-orange>&nbsp;</TD>
    <TD class=tabdata>
      <DIV align=right> <%tcWebApi_get("String_Entry","SetAdvPerfectForSecText","s")%>  </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
    <TD class=tabdata>
  ...
  <TR>
    ...
    <TD class=light-orange></TD>
    <TD class=tabdata>
      <DIV align=center><strong> <%tcWebApi_get("String_Entry","SetAdvKeyExchangePhase1Text","s")%> </strong></DIV>
    </TD></TR>
  <TR>
    <TD class=light-orange>&nbsp;</TD>
    <TD class=light-orange>&nbsp;</TD>
    <TD class=tabdata>
      <DIV align=right> <%tcWebApi_get("String_Entry","SetAdvKeyExchangeModeText","s")%>  </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
    <TD class=tabdata>
  ...
  <TR>
    ...
    <TD class=light-orange>&nbsp;</TD>
    <TD class=tabdata>
      <DIV align=right> <%tcWebApi_get("String_Entry","SetAdvEncryAlgText","s")%>  </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
    <TD class=tabdata>
  ...
  <TR>
    ...
    <TD class=light-orange>&nbsp;</TD>
    <TD class=tabdata>
      <DIV align=right> <%tcWebApi_get("String_Entry","SetAdvAuthAlgText","s")%>  </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
    <TD class=tabdata>
  ...
  <TR>
    ...
    <TD class=light-orange>&nbsp;</TD>
    <TD class=tabdata>
      <DIV align=right> <%tcWebApi_get("String_Entry","SetAdvDiffHellGroupText","s")%>  </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
    <TD class=tabdata>
  ...
  <TR>
    ...
    <TD class=light-orange></TD>
    <TD class=tabdata>
      <DIV align=right> <%tcWebApi_get("String_Entry","SetAdvKeyLifeTimeText","s")%>  </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
    <TD class=tabdata>
  ...
  <TR>
    ...
    <TD class=light-orange></TD>
    <TD class=tabdata>
      <DIV align=center><strong> <%tcWebApi_get("String_Entry","SetAdvKeyExchangePhase2Text","s")%> </strong></DIV>
    </TD></TR>
  <TR>
    <TD class=light-orange>&nbsp;</TD>
    <TD class=light-orange>&nbsp;</TD>
...
border=0>
  ...
  <TR height=42>
	...
	<INPUT onClick="doSubmit(1);" type=button value="<%tcWebApi_get("String_Entry","SetAdvSAVEText","s")%>" name="VpnSubmit">&nbsp;&nbsp;  
	<INPUT type="button" value="<%tcWebApi_get("String_Entry","SetAdvBACKText","s")%>" name="VpnBack" onClick="javascript:window.location='/cgi-bin/adv_vpn_setting.asp'" >&nbsp;&nbsp; 
