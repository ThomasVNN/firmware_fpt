...
function initValue()
{
	...
	else if ((1*PhyMode == 9) || (1*PhyMode == 6) || (1*PhyMode == 7))
	{
		if (document.wireless_basic.sz11gChannel.options.selectedIndex == 0)
		{
			document.getElementById("extension_channel").style.visibility = "hidden";
...
<td height="5" class="light-orange" colspan="4">&nbsp;</td>
  ...
  <tr>
	<td width="100" height="30" class="title-main"><font color="#FFFFFF"><%tcWebApi_get("String_Entry","WirelessBasicMenu0Text","s")%></font></td>
	<td width="10" >&nbsp;</td>
	<td width="200"></td> 
	<td width="450" id="basicWirelessNet"></td>
  </tr>
  <tr>
...
<table id="div_11n" name="div_11n" width="760" border="0" align=center cellpadding="0" cellspacing="0" bordercolor="#9BABBD" bgcolor="#FFFFFF">
  <tr>
      <td width="100" height="30" class="title-main"> <font color="#FFFFFF"><%tcWebApi_get("String_Entry","WirelessBasicMenu1Text","s")%></font> </td>
      <td width="10">&nbsp;</td>
      <td width="200"></td>
      <td width="450" id="basicHTPhyMode"></td>
  </tr>
  <tr id="div_n_mode">
      <td class="light-orange">&nbsp;</td>
      <td class="light-orange"></td>   
  ...
  <tr>
      <td class="light-orange">&nbsp;</td>
      <td class="light-orange"></td>   
    <td class="tabdata" id="basicHTRDG"><div align=right><%tcWebApi_get("String_Entry","WirelessBasicRDGText","s")%>:&nbsp;</div></td>
    <td class="tabdata">
  ...
  <tr>
      <td class="light-orange">&nbsp;</td>
      <td class="light-orange"></td>   
    <td class="tabdata" id="basicHTSTBC"><div align=right><%tcWebApi_get("String_Entry","WirelessBasicSpaceText","s")%>:&nbsp;</div></td>
    <td class="tabdata">
  ...
  <tr>
      <td class="light-orange">&nbsp;</td>
      <td class="light-orange"></td>   
    <td class="tabdata" id="basicHTAMSDU"><div align=right><%tcWebApi_get("String_Entry","WirelessBasicMSDUText","s")%>:&nbsp;</div></td>
    <td class="tabdata">
  ...
  <tr>
      <td class="light-orange">&nbsp;</td>
      <td class="light-orange"></td>   
    <td class="tabdata" id="basicHTAddBA"><div align=right><%tcWebApi_get("String_Entry","WirelessBasicABAText","s")%>:&nbsp;</div></td>
    <td class="tabdata">
...
<table id="div_11n_plugfest" name="div_11n_plugfest" width="760" border="0" align=center cellpadding="0" cellspacing="0" bordercolor="#9BABBD" bgcolor="#FFFFFF">
  <tr>
      <td width="100" height="30" class="title-main"> <font color="#FFFFFF"><%tcWebApi_get("String_Entry","WirelessBasicMenu2Text","s")%></font> </td>
      <td width="10">&nbsp;</td>
      <td width="200"></td>
      <td width="450" id="basicOther"></td>    
  </tr>
  <tr>
      <td class="light-orange">&nbsp;</td>
      <td class="light-orange"></td>   
